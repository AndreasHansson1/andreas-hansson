        ...
        <>
          ...
          <ParagraphWrapperSwe>
            <P>
              ...
              bästa. Jag är lojal och har hög integritet. Jag är gift och har
              två barn. Jag älskar att träna, även om det inte blir lika ofta
              som tidigare. Jag tränar nu för att genomföra mitt första marathon
              våren 2020, vilket jag ser fram emot. Jag gillar också att spela
              golf, padel, fiska, laga mat och älskar att åka skidor.
              <br />
              <br />
              <strong>Ett par saker jag gjort</strong> <br />
              Sidoprojekt sommaren 2019. Byggt med GatsbyJS, GraphQL,
              Gatsby-Image:{' '}
              <A href='https://blanchard.netlify.com'>
                {' '}
                blanchard{' '}
              </A> <br /> <br />
        ...
        <>
          ...
          <ParagraphWrapperEn>
            <P>
              ...
              this is so much fun. I love to learn so many new things! I studied
              2 years to frontend developer at
              <A href='https://nackademin.se/utbildningar/frontend-utvecklare/'>
                {' '}
                Nackademin{' '}
              </A>
              . After that I worked at We ahead, a consultant company.
              Techniques I worked with: React (GatsbyJS, NextJS), Javasctipt,
              HTML5, CSS3 (Emotion, Styled Components), Headless CMS (Dato,
              Contentful), Git, GraphQL. <br />
              <br />
              ...
              training to run a marathon spring 2020, and is excited about that.
              I also like to play golf, padel, fishing, cook food and loves to
              ski.
              <br />
              <br />
              <strong>A couple of things I have done</strong> <br />
              Own project summer 2019. Built with GatsbyJS, GraphQL,
              Gatsby-Image:{' '}
              <A href='https://blanchard.netlify.com'>
                {' '}
                blanchard{' '}
              </A> <br /> <br />
              Ex-job (with a classmate) spring 2019. Built with Vue and
              Firebase: <A href='https://www.carcalc.se/'> carcalc.se </A>
              <br />
              <br />
              Best <br />
              Andreas Hansson
